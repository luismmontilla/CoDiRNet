...
cr2 <- getClusterRelatedness(lc, hcmethod = "complete") #dissmililarity #between communities
cr2$height <- 100*cr2$height
#cr2$height <- 100-cr2$height
#plot(cr2, main="", sub="", xlab="Communities", ylab="Similarity (%)",
#     axes=F)
...
cr2.matrix <- getClusterRelatedness(lc, cluster = F) #Jaccard disimilarity
