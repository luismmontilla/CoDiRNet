...
pdf("analysis/figures/fig01.pdf")
...
pdf('analysis/figures/fig02.pdf')
...
members_1$attribute_s = factor(members_1$attribute, levels=c("Disease", "Genus", "Topic", "Ecoregion"))
...
members_2 <- lc$nodeclusters %>%
  ...
  mutate(attribute = factor(attribute, levels = unique(attribute)),
         abb = factor(abb, levels = sort(unique(abb), decreasing = T)))
levels(members_2$attribute) <- c("Topic", "Genus", "Disease",  "Ecoregion")
levels(members_2$cluster) <- c("C1", "C2", "C3", "C4", "C5","C6", "C7", "C8", "C9", "C10", "C11", "C12", "C13", "C14", "C15")
members_2$attribute_s = factor(members_2$attribute, levels=c("Disease", "Genus", "Topic", "Ecoregion"))
...
members_3 <- lc$nodeclusters %>%
  ...
  mutate(attribute = factor(attribute, levels = unique(attribute)),
         abb = factor(abb, levels = sort(unique(abb), decreasing = T)))
levels(members_3$attribute) <- c("Ecoregion", "Disease", "Topic", "Genus")
levels(members_3$cluster) <- c("C1", "C2", "C3", "C4", "C5","C6", "C7", "C8", "C9", "C10", "C11", "C12", "C13", "C14", "C15")
members_3$attribute_s = factor(members_3$attribute, levels=c("Disease", "Genus", "Topic", "Ecoregion"))
