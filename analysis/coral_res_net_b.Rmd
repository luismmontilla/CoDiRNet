...
```{r Data}
rawnet <- read.csv("master_coral_dis_net.csv", sep = ",", na.strings = "",
...
length(unique(tolower(as.character(coral.att$node)))) ## Hay 300 nodos en total segun el glosario
length(unique(tolower(names(V(coral.graph))))) ## Segun la red, hay 300 nodos en total
